            ...
            <nav class="mt-2">
                ...
                <li class="nav-item">
                    ...
                    @if (auth()->user()->can('site settings edit')||auth()->user()->can('contact information edit'))
                        <li class="nav-item @if(Route::is('contact.information.google.map')||Route::is('basic-settings.index')||Route::is('contact.information')||Route::is('privacy-policy.index')||Route::is('privacy-policy.edit')||Route::is('return-policy.index')||Route::is('return-policy.edit')||Route::is('terms-and-conditions.index')||Route::is('terms-and-conditions.edit')) menu-open @endif">
                            <a href="#" class="nav-link @if(Route::is('contact.information.google.map')||Route::is('basic-settings.index')||Route::is('contact.information')||Route::is('privacy-policy.index')||Route::is('privacy-policy.edit')||Route::is('return-policy.index')||Route::is('return-policy.edit')||Route::is('terms-and-conditions.index')||Route::is('terms-and-conditions.edit')) active @endif">
