                            ...
                            <div class="category-left">
                                ...
                                <nav id="main-nav">
                                    ...
                                    <!--blog-meu start-->
                                        ...
                                        <li>
                                            <a href="{{ route('frontend.contact.us') }}" class="dark-menu-item has-submenu" id="sm-16353491369166194-3" aria-haspopup="true" aria-controls="sm-16353491369166194-4" aria-expanded="false">
                                                Contact
                                            </a>
                                        </li>
                                        @auth
                ...
                <div class="col">
                    <div class="contact-banner-contain">
                        <div class="contact-banner-img"><img src="{{ asset('assets/images/layout-1/call-img.png') }}" class="  img-fluid" alt="call-banner"></div>
                            <div> <h3 class="text-white">if you have any question please call us</h3></div>
                        <div><h2 class="text-white">{{ contactMobile()[0]->number }}</h2></div>
                    </div>
                </div>
            </div>
        </div>
                                                        ...
                                                        <div class="footer-box">
                                                            ...
                                                            <div class="footer-contant">
                                                                <ul>
                                                                    ...
                                                                    <li><a href="{{ route('frontend.size.guide') }}"> size guide</a></li>
                                                                    <li><a href="{{ route('frontend.terms.conditions') }}">terms &amp; conditions</a></li>
                                                                    <li><a href="{{ route('frontend.shipping.delivery') }}">shipping &amp; delivery</a></li>
